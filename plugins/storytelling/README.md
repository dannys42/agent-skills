...
An audience-aware storytelling and narrative-copy plugin.

## Skill

`crafting-compelling-stories` plans, drafts, and edits stories for marketing,
speeches, education, scripts, and fiction while preserving supplied facts and voice.
...
See the repository root [installation guide](../../README.md#install-crafting-compelling-stories).
